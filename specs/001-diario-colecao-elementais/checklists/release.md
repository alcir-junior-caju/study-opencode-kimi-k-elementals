...
- [x] CHK018 O acesso a um ID inexistente na tela individual define redirecionamento para a página inicial sem tela em branco ou erro fatal, tanto em navegação client-side quanto em acesso direto à URL? [Coverage, Spec §FR-016/História 3 cenário 6] <!-- Phase 3: placeholder em src/routes/elemental/[id]/+page.ts redireciona 307 → /; a implementação definitiva será Phase 5, mas o comportamento já está especificado e com rota válida no build. -->
